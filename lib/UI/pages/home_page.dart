...
//       runDeepLinkActionOld(context, appProvider.initialUri, appProvider.isAuth, homeProvider);
...
//               runDeepLinkActionOld(context, Uri.parse(event.additionalData['deep_link']), appProvider.isAuth, homeProvider);
